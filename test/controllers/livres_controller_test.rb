...
class LivresControllerTest < ActionController::TestCase
  ...
  test "should create livre" do
    assert_difference('Livre.count') do
      post :create, livre: { autheur: @livre.autheur, avis: @livre.avis, description: @livre.description, titre: @livre.titre }
    end
  ...
  test "should update livre" do
    patch :update, id: @livre, livre: { autheur: @livre.autheur, avis: @livre.avis, description: @livre.description, titre: @livre.titre }
    assert_redirected_to livre_path(assigns(:livre))
  end
